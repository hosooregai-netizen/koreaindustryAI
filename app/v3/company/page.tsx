...
export const metadata: Metadata = {
  ...
  description: "대한산업AI 주식회사의 기업 업무 자동화 구현 역량과 작업 방식입니다.",
};
...
const trustFacts = ["법인 고객 대상", "방문 진단 가능", "기존 시스템 유지", "권한 / 보안 설계"];
    ...
    <V3Shell>
      <main>
        ...
        <section className="v3-section v3-dark">
          <V3SectionHeading eyebrow="Process" title="도입 과정" />
          <V3Process />
        </section>

        <section className="v3-section v3-soft">
          <V3SectionHeading eyebrow="Story" title="대한산업AI의 적용 관점" />
          <V3StoryCards />
        </section>
